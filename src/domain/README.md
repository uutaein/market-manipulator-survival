...
The current domain layer supports early Run and Day setup. It does not yet include pre-open card effects, price ticks, actions, settlement, carryover, or persistence modules.

BDD steps currently exercise this domain layer for Run start, same-seed restart, asset catalog completeness, hidden profile assignment, Morning News generation, and Market Briefing data.
