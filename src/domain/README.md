...
The current domain layer supports early Run, Day setup, Pre-open Card selection, the player asset intraday tick skeleton, Manual Action state effects, Auto Card rewards/effects, Document Event decisions, and Retail Swarm state modeling. It does not yet include settlement, carryover, or persistence modules.
