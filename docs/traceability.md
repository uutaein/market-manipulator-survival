...
| FEAT-006 | Run Seed and same-condition restart | PRD v0.1.5; ADR-0024 | SRS v0.1.0, v0.1.2, v0.1.4 | [run_lifecycle.feature](../feature/run/run_lifecycle.feature), [local_storage.feature](../feature/persistence/local_storage.feature) | TC-SEED-001 | SPEC Accepted / Gherkin Drafted / Step Definitions Drafted / Domain Implemented / TC Planned | Core same-seed Run recreation and current Run save/load domain support exist; UI wiring pending. |
...
| FEAT-018 | Market Board | PRD v0.1.5; ADR-0016 | SRS v0.1.0, v0.1.3, v0.1.6 | [market_board.feature](../feature/market/market_board.feature) | TC-MARKET-001 | SPEC Accepted / Gherkin Drafted / Step Definitions Drafted / Domain Implemented / TC Planned | 1 detailed player entry, 2 same-sector peers, 5 representative simplified assets, and news-priority selection exist in `src/domain/market/marketBoard.ts`; scene rendering pending. |
| FEAT-019 | Day Settlement | PRD v0.1.5; ADR-0008; ADR-0015 | SRS v0.1.0, v0.1.4, v0.1.6 | [day_and_final_settlement.feature](../feature/settlement/day_and_final_settlement.feature) | TC-SETTLE-001 | SPEC Accepted / Gherkin Drafted / Step Definitions Drafted / Domain Implemented / TC Planned | Profit bands, surveillance grades, and Day result matrix exist in `src/domain/settlement/settlement.ts`; scene rendering pending. |
| FEAT-020 | Final Settlement | PRD v0.1.5; ADR-0008; ADR-0015 | SRS v0.1.0, v0.1.4, v0.1.6 | [day_and_final_settlement.feature](../feature/settlement/day_and_final_settlement.feature) | TC-FINAL-001 | SPEC Accepted / Gherkin Drafted / Step Definitions Drafted / Domain Implemented / TC Planned | Final grade baselines, forced failure handling, and downgrade rules exist in `src/domain/settlement/settlement.ts`; scene rendering pending. |
