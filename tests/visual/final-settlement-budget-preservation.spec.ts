...
import {
  ...
  prepareBudgetPreservationFinalSettlementState,
  resetBrowserState,
} from "./support/canvas";

test("final settlement budget preservation visual baseline", async ({
  page,
}) => {
  ...
  await prepareBudgetPreservationFinalSettlementState(page);
  ...
  await expect(page).toHaveScreenshot(
    "final-settlement-budget-preservation.png",
    {
      animations: "disabled",
      fullPage: true,
    },
