...
import {
  ...
  prepareSocialCostFinalSettlementState,
  resetBrowserState,
} from "./support/canvas";

test("final settlement social cost adjustment visual baseline", async ({
  page,
}) => {
  ...
  await prepareSocialCostFinalSettlementState(page);
  ...
  await expect(page).toHaveScreenshot(
    "final-settlement-social-cost-adjustment.png",
    {
      animations: "disabled",
      fullPage: true,
    },
