...
import {
  expectCanvasReady,
  prepareBudgetPreservationDaySettlementState,
  resetBrowserState,
} from "./support/canvas";

test("day settlement budget preservation visual baseline", async ({ page }) => {
  ...
  await prepareBudgetPreservationDaySettlementState(page);
  ...
  await expect(page).toHaveScreenshot(
    "day-settlement-budget-preservation.png",
    {
      animations: "disabled",
      fullPage: true,
    },
